...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
     ...
     <img src="/assets/HeroImages/hero1.png" className="w-full h-44"></img>
    </motion.div>
  );
};
const SkeletonTwo = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
     <img src="/assets/HeroImages/hero2.png" className="w-full h-44"></img>
    </motion.div>
  );
};
const SkeletonThree = () => {
  ...
  return (
    ...
    >
      <img src="/assets/HeroImages/hero3.png" className="w-full h-44"></img>
    </motion.div>
  );
};
const SkeletonFour = () => {
