...
export default function Gallery4() {
  return (
    <div className="p-4">
        <Card className="relative  group/card transition-all duration-500 ease-out hover:bg-[#BA75F4]  bg-white h-[250px]">
                      ...
                      <div className="flex items-center h-full p-12 relative z-20">
                        ...
                        {/* Center image */}
                        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[250px] transform transition-all duration-500 ease-out opacity-0 group-hover/card:opacity-100 scale-90 group-hover/card:scale-100 z-20">
