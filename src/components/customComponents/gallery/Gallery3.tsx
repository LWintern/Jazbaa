...
export default function Gallery3() {
  return (
    <div className="relative p-4">
      <Card className="relative mx-auto group/card transition-all duration-500 ease-out hover:bg-[#F3C345] bg-white h-auto">
        ...
        <div className="flex flex-col md:flex-row items-center h-full p-6 md:p-12 relative z-20">
          ...
          {/* Center image */}
          <div className="relative w-full h-[200px] md:w-auto md:h-[250px] mb-4 md:mb-0 transition-all duration-500 ease-out opacity-100 scale-100 z-20">
