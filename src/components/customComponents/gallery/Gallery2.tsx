...
//       <Card className="relative mx-auto group transition-all duration-500 ease-out hover:bg-[#60C0ED] bg-white h-auto max-w-6xl md:h-[200px]">
...
//           <div className="relative w-full md:h-[200px] block md:hidden mb-4 transition-all duration-500 ease-out z-50">
...
//           <div className="hidden md:block relative w-auto md:h-[200px] mb-0 transition-all duration-500 ease-out z-50 opacity-0 group-hover:opacity-100">
//             <div className="relative md:w-[300px] h-full transform group-hover:rotate-6 transition-transform duration-500">
//               <Image
//                 src="/assets/mentor-with-VIPS/techie1.png"
//                 alt="Content Creator"
//                 fill
