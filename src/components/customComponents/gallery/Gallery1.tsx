...
export default function Gallery() {
  return (
    <div className="relative p-4 md:p-4">
      <Card className="relative mx-auto group transition-all duration-500 ease-out hover:bg-black bg-white h-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row items-center h-full p-6 md:p-12 relative z-20">
          ...
          {/* Center image */}
          <div className="relative w-full h-[200px] md:w-auto md:h-[250px] mb-4 md:mb-0 transform transition-all duration-500 ease-out opacity-0 lg:group-hover:opacity-100 scale-100 z-50">
            <div className="relative w-full h-full transform group-hover:rotate-6 transition-transform duration-500">
              <Image
          ...
          {/* Right side content */}
          <div className="w-full md:w-2/3 pl-0 md:pl-8 relative z-1 transition-transform duration-500 ease-out transform group-hover:translate-x-0 md:group-hover:translate-x-28">
