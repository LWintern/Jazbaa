  ...
  return (
    <div className="bg-black text-white min-h-full ">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="relative rounded-2xl bg-gray-900/50 p-8 backdrop-blur-sm border border-gray-800">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="space-y-12">
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl font-semibold">Inclusivity</h2>
              ...
              {/* Statistics */}
              <div className="grid grid-cols-2 gap-8 pt-4 relative">
                {/* Vertical Divider */}
                <div className="absolute top-0 bottom-0 left-1/2 w-px bg-gray-800"></div>
                
                <div>
                  <h3 className="text-xl font-medium mb-6">Student</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium mb-6">Employee</h3>
                  <div className="space-y-6">
                    <div>
                      <div className="text-5xl font-bold tracking-tight">
            ...
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 opacity-20">
                <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-yellow-400/30"></div>
                <div className="absolute top-0 right-0 w-20 h-20 border-t-2 border-r-2 border-yellow-400/30"></div>
                <div className="absolute bottom-0 left-0 w-20 h-20 border-b-2 border-l-2 border-yellow-400/30"></div>
                <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-yellow-400/30"></div>
              </div>
              ...
              <div className="absolute top-8 left-0 right-0 text-center">
                <h3 className="text-3xl font-bold tracking-[0.2em]" 
